...
namespace Cursos.Controllers
{
    ...
    public class LoginController:Controller
    {
        ...
        public LoginController(cursosContext _context, IConfiguration _config)
        {
            context = _context;
            config = _config;
        }
        ...
        public async Task<IActionResult> Post(LoginVM Login)
        {
            ...
            Usuarios Usuario = await context.Usuarios.Where(x=>x.Usuario == Login.Usuario).FirstOrDefaultAsync();
            if(Usuario == null)
            {
